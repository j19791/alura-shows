					...
					<div class="row">
						<div class="col-lg-12">
							<form id="login-form" action="${s:mvcUrl('UC#login').build()}"
								method="post" role="form" style="display: block;"><!-- diminuindo a vulnerabilidade trocando por post -->
								...
								<!-- <div class="g-recaptcha" data-sitekey="6Le_AZgUAAAAACHKeJaXYnZYtqJ6ar3VgpR-5rZo"></div> -->
